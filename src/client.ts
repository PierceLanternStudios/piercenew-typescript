...
export class Piercenew {
  ...
  constructor({
    ...
    this.logLevel = parseLogLevel(options.logLevel, 'ClientOptions.logLevel', this) ?? parseLogLevel(readEnv('PIERCENEW_LOG'), 'process.env[\'PIERCENEW_LOG\']', this) ?? defaultLogLevel;
