...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    perLanguage: {
      ...
      python: {
        method: 'pets.update',
        example:
          'import os\nfrom piercenew import Piercenew\n\nclient = Piercenew(\n    api_key=os.environ.get("PETSTORE_API_KEY"),  # This is the default and can be omitted\n)\npet = client.pets.update(\n    name="doggie",\n    photo_urls=["string"],\n)\nprint(pet.id)',
      },
      java: {
        method: 'pets().update',
        example:
          'package com.piercenew.api.example;\n\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.models.pets.Pet;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        PiercenewClient client = PiercenewOkHttpClient.fromEnv();\n\n        Pet params = Pet.builder()\n            .name("doggie")\n            .addPhotoUrl("string")\n            .build();\n        Pet pet = client.pets().update(params);\n    }\n}',
      },
      go: {
        method: 'client.Pets.Update',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/piercenew-go"\n\t"github.com/stainless-sdks/piercenew-go/option"\n)\n\nfunc main() {\n\tclient := piercenew.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tpet, err := client.Pets.Update(context.TODO(), piercenew.PetUpdateParams{\n\t\tPet: piercenew.PetParam{\n\t\t\tName:      "doggie",\n\t\t\tPhotoURLs: []string{"string"},\n\t\t},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", pet.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/piercenew-go"\n\t"github.com/stainless-sdks/piercenew-go/option"\n)\n\nfunc main() {\n\tclient := piercenew.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tpet, err := client.Pets.New(context.TODO(), piercenew.PetNewParams{\n\t\tPet: piercenew.PetParam{\n\t\t\tName:      "doggie",\n\t\t\tPhotoURLs: []string{"string"},\n\t\t},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", pet.ID)\n}\n',
      },
      http: {
        example:
          'curl https://petstore3.swagger.io/api/v3/pet \\\n    -H \'Content-Type: application/json\' \\\n    -H "api_key: $PETSTORE_API_KEY" \\\n    -d \'{\n          "name": "doggie",\n          "photoUrls": [\n            "string"\n          ],\n          "id": 10\n        }\'',
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        ...
        example:
          'package com.piercenew.api.example;\n\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.models.pets.Pet;\nimport com.piercenew.api.models.pets.PetFindByStatusParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        PiercenewClient client = PiercenewOkHttpClient.fromEnv();\n\n        List<Pet> pets = client.pets().findByStatus();\n    }\n}',
      },
      go: {
        method: 'client.Pets.FindByStatus',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/piercenew-go"\n\t"github.com/stainless-sdks/piercenew-go/option"\n)\n\nfunc main() {\n\tclient := piercenew.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tpets, err := client.Pets.FindByStatus(context.TODO(), piercenew.PetFindByStatusParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", pets)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        ...
        example:
          'package com.piercenew.api.example;\n\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.models.pets.Pet;\nimport com.piercenew.api.models.pets.PetFindByTagsParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        PiercenewClient client = PiercenewOkHttpClient.fromEnv();\n\n        List<Pet> pets = client.pets().findByTags();\n    }\n}',
      },
      go: {
        method: 'client.Pets.FindByTags',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/piercenew-go"\n\t"github.com/stainless-sdks/piercenew-go/option"\n)\n\nfunc main() {\n\tclient := piercenew.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tpets, err := client.Pets.FindByTags(context.TODO(), piercenew.PetFindByTagsParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", pets)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        method: 'pets().retrieve',
        example:
          'package com.piercenew.api.example;\n\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.models.pets.Pet;\nimport com.piercenew.api.models.pets.PetRetrieveParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        PiercenewClient client = PiercenewOkHttpClient.fromEnv();\n\n        Pet pet = client.pets().retrieve(0L);\n    }\n}',
      },
      go: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        ...
        example:
          'package com.piercenew.api.example;\n\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.models.pets.PetUpdateByIdParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        PiercenewClient client = PiercenewOkHttpClient.fromEnv();\n\n        client.pets().updateById(0L);\n    }\n}',
      },
      go: {
        method: 'client.Pets.UpdateByID',
        example:
          'package main\n\nimport (\n\t"context"\n\n\t"github.com/stainless-sdks/piercenew-go"\n\t"github.com/stainless-sdks/piercenew-go/option"\n)\n\nfunc main() {\n\tclient := piercenew.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\terr := client.Pets.UpdateByID(\n\t\tcontext.TODO(),\n\t\t0,\n\t\tpiercenew.PetUpdateByIDParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n}\n',
      },
      http: {
        example:
          'curl https://petstore3.swagger.io/api/v3/pet/$PET_ID \\\n    -X POST \\\n    -H "api_key: $PETSTORE_API_KEY"',
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        method: 'pets().delete',
        example:
          'package com.piercenew.api.example;\n\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.models.pets.PetDeleteParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        PiercenewClient client = PiercenewOkHttpClient.fromEnv();\n\n        client.pets().delete(0L);\n    }\n}',
      },
      go: {
        method: 'client.Pets.Delete',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        ...
        example:
          'package com.piercenew.api.example;\n\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.models.pets.PetUploadImageParams;\nimport com.piercenew.api.models.pets.PetUploadImageResponse;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        PiercenewClient client = PiercenewOkHttpClient.fromEnv();\n\n        PetUploadImageResponse response = client.pets().uploadImage(\n          0L, "Example data"\n        );\n    }\n}',
      },
      go: {
        method: 'client.Pets.UploadImage',
        example:
          'package main\n\nimport (\n\t"bytes"\n\t"context"\n\t"fmt"\n\t"io"\n\n\t"github.com/stainless-sdks/piercenew-go"\n\t"github.com/stainless-sdks/piercenew-go/option"\n)\n\nfunc main() {\n\tclient := piercenew.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tresponse, err := client.Pets.UploadImage(\n\t\tcontext.TODO(),\n\t\t0,\n\t\tio.Reader(bytes.NewBuffer([]byte("Example data"))),\n\t\tpiercenew.PetUploadImageParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response.Code)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        ...
        example:
          'package com.piercenew.api.example;\n\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.models.store.StoreListInventoryParams;\nimport com.piercenew.api.models.store.StoreListInventoryResponse;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        PiercenewClient client = PiercenewOkHttpClient.fromEnv();\n\n        StoreListInventoryResponse response = client.store().listInventory();\n    }\n}',
      },
      go: {
        method: 'client.Store.ListInventory',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        method: 'store().orders().create',
        example:
          'package com.piercenew.api.example;\n\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.models.Order;\nimport com.piercenew.api.models.store.orders.OrderCreateParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        PiercenewClient client = PiercenewOkHttpClient.fromEnv();\n\n        Order order = client.store().orders().create();\n    }\n}',
      },
      go: {
        method: 'client.Store.Orders.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/piercenew-go"\n\t"github.com/stainless-sdks/piercenew-go/option"\n)\n\nfunc main() {\n\tclient := piercenew.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\torder, err := client.Store.Orders.New(context.TODO(), piercenew.StoreOrderNewParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", order.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        method: 'store().orders().retrieve',
        example:
          'package com.piercenew.api.example;\n\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.models.Order;\nimport com.piercenew.api.models.store.orders.OrderRetrieveParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        PiercenewClient client = PiercenewOkHttpClient.fromEnv();\n\n        Order order = client.store().orders().retrieve(0L);\n    }\n}',
      },
      go: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        method: 'store().orders().delete',
        example:
          'package com.piercenew.api.example;\n\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.models.store.orders.OrderDeleteParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        PiercenewClient client = PiercenewOkHttpClient.fromEnv();\n\n        client.store().orders().delete(0L);\n    }\n}',
      },
      go: {
        method: 'client.Store.Orders.Delete',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        method: 'users().create',
        example:
          'package com.piercenew.api.example;\n\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.models.users.User;\nimport com.piercenew.api.models.users.UserCreateParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        PiercenewClient client = PiercenewOkHttpClient.fromEnv();\n\n        User user = client.users().create();\n    }\n}',
      },
      go: {
        method: 'client.Users.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/piercenew-go"\n\t"github.com/stainless-sdks/piercenew-go/option"\n)\n\nfunc main() {\n\tclient := piercenew.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tuser, err := client.Users.New(context.TODO(), piercenew.UserNewParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", user.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        ...
        example:
          'package com.piercenew.api.example;\n\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.models.users.User;\nimport com.piercenew.api.models.users.UserCreateWithListParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        PiercenewClient client = PiercenewOkHttpClient.fromEnv();\n\n        User user = client.users().createWithList();\n    }\n}',
      },
      go: {
        method: 'client.Users.NewWithList',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/piercenew-go"\n\t"github.com/stainless-sdks/piercenew-go/option"\n)\n\nfunc main() {\n\tclient := piercenew.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tuser, err := client.Users.NewWithList(context.TODO(), piercenew.UserNewWithListParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", user.ID)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        method: 'users().login',
        example:
          'package com.piercenew.api.example;\n\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.models.users.UserLoginParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        PiercenewClient client = PiercenewOkHttpClient.fromEnv();\n\n        String response = client.users().login();\n    }\n}',
      },
      go: {
        method: 'client.Users.Login',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/piercenew-go"\n\t"github.com/stainless-sdks/piercenew-go/option"\n)\n\nfunc main() {\n\tclient := piercenew.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tresponse, err := client.Users.Login(context.TODO(), piercenew.UserLoginParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response)\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        method: 'users().logout',
        example:
          'package com.piercenew.api.example;\n\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.models.users.UserLogoutParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        PiercenewClient client = PiercenewOkHttpClient.fromEnv();\n\n        client.users().logout();\n    }\n}',
      },
      go: {
        method: 'client.Users.Logout',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        method: 'users().retrieve',
        example:
          'package com.piercenew.api.example;\n\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.models.users.User;\nimport com.piercenew.api.models.users.UserRetrieveParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        PiercenewClient client = PiercenewOkHttpClient.fromEnv();\n\n        User user = client.users().retrieve("username");\n    }\n}',
      },
      go: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        method: 'users().update',
        example:
          'package com.piercenew.api.example;\n\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.models.users.UserUpdateParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        PiercenewClient client = PiercenewOkHttpClient.fromEnv();\n\n        client.users().update("username");\n    }\n}',
      },
      go: {
        method: 'client.Users.Update',
        example:
          'package main\n\nimport (\n\t"context"\n\n\t"github.com/stainless-sdks/piercenew-go"\n\t"github.com/stainless-sdks/piercenew-go/option"\n)\n\nfunc main() {\n\tclient := piercenew.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\terr := client.Users.Update(\n\t\tcontext.TODO(),\n\t\t"username",\n\t\tpiercenew.UserUpdateParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n}\n',
      },
      http: {
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        method: 'users().delete',
        example:
          'package com.piercenew.api.example;\n\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.models.users.UserDeleteParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        PiercenewClient client = PiercenewOkHttpClient.fromEnv();\n\n        client.users().delete("username");\n    }\n}',
      },
      go: {
        method: 'client.Users.Delete',
        example:
...
const EMBEDDED_READMES: { language: string; content: string }[] = [
  {
    language: 'go',
    content:
      '# Piercenew Go API Library\n\n<a href="https://pkg.go.dev/github.com/stainless-sdks/piercenew-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/piercenew-go.svg" alt="Go Reference"></a>\n\nThe Piercenew Go library provides convenient access to the Piercenew REST API\nfrom applications written in Go.\n\nIt is generated with [Stainless](https://www.stainless.com/).\n\n## MCP Server\n\nUse the Piercenew MCP Server to enable AI assistants to interact with this API, allowing them to explore endpoints, make test requests, and use documentation to help integrate this SDK into your application.\n\n[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=piercenew-mcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyIteSIsInBpZXJjZW5ldy1tY3AiXSwiZW52Ijp7IlBFVFNUT1JFX0FQSV9LRVkiOiJNeSBBUEkgS2V5In19)\n[![Install in VS Code](https://img.shields.io/badge/_-Add_to_VS_Code-blue?style=for-the-badge&logo=data:image/svg%2bxml;base64,)](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22piercenew-mcp%22%2C%22command%22%3A%22npx%22%2C%22args%22%3A%5B%22-y%22%2C%22piercenew-mcp%22%5D%2C%22env%22%3A%7B%22PETSTORE_API_KEY%22%3A%22My%20API%20Key%22%7D%7D)\n\n> Note: You may need to set environment variables in your MCP client.\n\n## Installation\n\n\n\n```go\nimport (\n\t"github.com/stainless-sdks/piercenew-go" // imported as SDK_PackageName\n)\n```\n\n\n\nOr to pin the version:\n\n\n\n```sh\ngo get -u \'github.com/stainless-sdks/piercenew-go@v0.0.1\'\n```\n\n\n\n## Requirements\n\nThis library requires Go 1.22+.\n\n## Usage\n\nThe full API of this library can be found in [api.md](api.md).\n\n```go\npackage main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/piercenew-go"\n\t"github.com/stainless-sdks/piercenew-go/option"\n)\n\nfunc main() {\n\tclient := piercenew.NewClient(\n\t\toption.WithAPIKey("My API Key"), // defaults to os.LookupEnv("PETSTORE_API_KEY")\n\t)\n\torder, err := client.Store.Orders.New(context.TODO(), piercenew.StoreOrderNewParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", order.ID)\n}\n\n```\n\n### Request fields\n\nAll request parameters are wrapped in a generic `Field` type,\nwhich we use to distinguish zero values from null or omitted fields.\n\nThis prevents accidentally sending a zero value if you forget a required parameter,\nand enables explicitly sending `null`, `false`, `\'\'`, or `0` on optional parameters.\nAny field not specified is not sent.\n\nTo construct fields with values, use the helpers `String()`, `Int()`, `Float()`, or most commonly, the generic `F[T]()`.\nTo send a null, use `Null[T]()`, and to send a nonconforming value, use `Raw[T](any)`. For example:\n\n```go\nparams := FooParams{\n\tName: SDK_PackageName.F("hello"),\n\n\t// Explicitly send `"description": null`\n\tDescription: SDK_PackageName.Null[string](),\n\n\tPoint: SDK_PackageName.F(SDK_PackageName.Point{\n\t\tX: SDK_PackageName.Int(0),\n\t\tY: SDK_PackageName.Int(1),\n\n\t\t// In cases where the API specifies a given type,\n\t\t// but you want to send something else, use `Raw`:\n\t\tZ: SDK_PackageName.Raw[int64](0.01), // sends a float\n\t}),\n}\n```\n\n### Response objects\n\nAll fields in response structs are value types (not pointers or wrappers).\n\nIf a given field is `null`, not present, or invalid, the corresponding field\nwill simply be its zero value.\n\nAll response structs also include a special `JSON` field, containing more detailed\ninformation about each property, which you can use like so:\n\n```go\nif res.Name == "" {\n\t// true if `"name"` is either not present or explicitly null\n\tres.JSON.Name.IsNull()\n\n\t// true if the `"name"` key was not present in the response JSON at all\n\tres.JSON.Name.IsMissing()\n\n\t// When the API returns data that cannot be coerced to the expected type:\n\tif res.JSON.Name.IsInvalid() {\n\t\traw := res.JSON.Name.Raw()\n\n\t\tlegacyName := struct{\n\t\t\tFirst string `json:"first"`\n\t\t\tLast  string `json:"last"`\n\t\t}{}\n\t\tjson.Unmarshal([]byte(raw), &legacyName)\n\t\tname = legacyName.First + " " + legacyName.Last\n\t}\n}\n```\n\nThese `.JSON` structs also include an `Extras` map containing\nany properties in the json response that were not specified\nin the struct. This can be useful for API features not yet\npresent in the SDK.\n\n```go\nbody := res.JSON.ExtraFields["my_unexpected_field"].Raw()\n```\n\n### RequestOptions\n\nThis library uses the functional options pattern. Functions defined in the\n`SDK_PackageOptionName` package return a `RequestOption`, which is a closure that mutates a\n`RequestConfig`. These options can be supplied to the client or at individual\nrequests. For example:\n\n```go\nclient := SDK_PackageName.SDK_ClientInitializerName(\n\t// Adds a header to every request made by the client\n\tSDK_PackageOptionName.WithHeader("X-Some-Header", "custom_header_info"),\n)\n\nclient.Store.ListInventory(context.TODO(), ...,\n\t// Override the header\n\tSDK_PackageOptionName.WithHeader("X-Some-Header", "some_other_custom_header_info"),\n\t// Add an undocumented field to the request body, using sjson syntax\n\tSDK_PackageOptionName.WithJSONSet("some.json.path", map[string]string{"my": "object"}),\n)\n```\n\nSee the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/piercenew-go/SDK_PackageOptionName).\n\n### Pagination\n\nThis library provides some conveniences for working with paginated list endpoints.\n\nYou can use `.ListAutoPaging()` methods to iterate through items across all pages:\n\n\n\nOr you can use simple `.List()` methods to fetch a single page and receive a standard response object\nwith additional helper methods like `.GetNextPage()`, e.g.:\n\n\n\n### Errors\n\nWhen the API returns a non-success status code, we return an error with type\n`*SDK_PackageName.Error`. This contains the `StatusCode`, `*http.Request`, and\n`*http.Response` values of the request, as well as the JSON of the error body\n(much like other response objects in the SDK).\n\nTo handle errors, we recommend that you use the `errors.As` pattern:\n\n```go\n_, err := client.Store.ListInventory(context.TODO())\nif err != nil {\n\tvar apierr *piercenew.Error\n\tif errors.As(err, &apierr) {\n\t\tprintln(string(apierr.DumpRequest(true)))  // Prints the serialized HTTP request\n\t\tprintln(string(apierr.DumpResponse(true))) // Prints the serialized HTTP response\n\t}\n\tpanic(err.Error()) // GET "/store/inventory": 400 Bad Request { ... }\n}\n```\n\nWhen other errors occur, they are returned unwrapped; for example,\nif HTTP transport fails, you might receive `*url.Error` wrapping `*net.OpError`.\n\n### Timeouts\n\nRequests do not time out by default; use context to configure a timeout for a request lifecycle.\n\nNote that if a request is [retried](#retries), the context timeout does not start over.\nTo set a per-retry timeout, use `SDK_PackageOptionName.WithRequestTimeout()`.\n\n```go\n// This sets the timeout for the request, including all the retries.\nctx, cancel := context.WithTimeout(context.Background(), 5*time.Minute)\ndefer cancel()\nclient.Store.ListInventory(\n\tctx,\n\t// This sets the per-retry timeout\n\toption.WithRequestTimeout(20*time.Second),\n)\n```\n\n### File uploads\n\nRequest parameters that correspond to file uploads in multipart requests are typed as\n`param.Field[io.Reader]`. The contents of the `io.Reader` will by default be sent as a multipart form\npart with the file name of "anonymous_file" and content-type of "application/octet-stream".\n\nThe file name and content-type can be customized by implementing `Name() string` or `ContentType()\nstring` on the run-time type of `io.Reader`. Note that `os.File` implements `Name() string`, so a\nfile returned by `os.Open` will be sent with the file name on disk.\n\nWe also provide a helper `SDK_PackageName.FileParam(reader io.Reader, filename string, contentType string)`\nwhich can be used to wrap any `io.Reader` with the appropriate file name and content type.\n\n\n\n### Retries\n\nCertain errors will be automatically retried 2 times by default, with a short exponential backoff.\nWe retry by default all connection errors, 408 Request Timeout, 409 Conflict, 429 Rate Limit,\nand >=500 Internal errors.\n\nYou can use the `WithMaxRetries` option to configure or disable this:\n\n```go\n// Configure the default for all requests:\nclient := piercenew.NewClient(\n\toption.WithMaxRetries(0), // default is 2\n)\n\n// Override per-request:\nclient.Store.ListInventory(context.TODO(), option.WithMaxRetries(5))\n```\n\n\n### Accessing raw response data (e.g. response headers)\n\nYou can access the raw HTTP response data by using the `option.WithResponseInto()` request option. This is useful when\nyou need to examine response headers, status codes, or other details.\n\n```go\n// Create a variable to store the HTTP response\nvar response *http.Response\nresponse, err := client.Store.ListInventory(context.TODO(), option.WithResponseInto(&response))\nif err != nil {\n\t// handle error\n}\nfmt.Printf("%+v\\n", response)\n\nfmt.Printf("Status Code: %d\\n", response.StatusCode)\nfmt.Printf("Headers: %+#v\\n", response.Header)\n```\n\n### Making custom/undocumented requests\n\nThis library is typed for convenient access to the documented API. If you need to access undocumented\nendpoints, params, or response properties, the library can still be used.\n\n#### Undocumented endpoints\n\nTo make requests to undocumented endpoints, you can use `client.Get`, `client.Post`, and other HTTP verbs.\n`RequestOptions` on the client, such as retries, will be respected when making these requests.\n\n```go\nvar (\n    // params can be an io.Reader, a []byte, an encoding/json serializable object,\n    // or a "…Params" struct defined in this library.\n    params map[string]interface{}\n\n    // result can be an []byte, *http.Response, a encoding/json deserializable object,\n    // or a model defined in this library.\n    result *http.Response\n)\nerr := client.Post(context.Background(), "/unspecified", params, &result)\nif err != nil {\n    …\n}\n```\n\n#### Undocumented request params\n\nTo make requests using undocumented parameters, you may use either the `SDK_PackageOptionName.WithQuerySet()`\nor the `SDK_PackageOptionName.WithJSONSet()` methods.\n\n```go\nparams := FooNewParams{\n    ID:   SDK_PackageName.F("id_xxxx"),\n    Data: SDK_PackageName.F(FooNewParamsData{\n        FirstName: SDK_PackageName.F("John"),\n    }),\n}\nclient.Foo.New(context.Background(), params, SDK_PackageOptionName.WithJSONSet("data.last_name", "Doe"))\n```\n\n#### Undocumented response properties\n\nTo access undocumented response properties, you may either access the raw JSON of the response as a string\nwith `result.JSON.RawJSON()`, or get the raw JSON of a particular field on the result with\n`result.JSON.Foo.Raw()`.\n\nAny fields that are not present on the response struct will be saved and can be accessed by `result.JSON.ExtraFields()` which returns the extra fields as a `map[string]Field`.\n\n### Middleware\n\nWe provide `SDK_PackageOptionName.WithMiddleware` which applies the given\nmiddleware to requests.\n\n```go\nfunc Logger(req *http.Request, next SDK_PackageOptionName.MiddlewareNext) (res *http.Response, err error) {\n\t// Before the request\n\tstart := time.Now()\n\tLogReq(req)\n\n\t// Forward the request to the next handler\n\tres, err = next(req)\n\n\t// Handle stuff after the request\n\tend := time.Now()\n\tLogRes(res, err, start - end)\n\n    return res, err\n}\n\nclient := SDK_PackageName.SDK_ClientInitializerName(\n\tSDK_PackageOptionName.WithMiddleware(Logger),\n)\n```\n\nWhen multiple middlewares are provided as variadic arguments, the middlewares\nare applied left to right. If `SDK_PackageOptionName.WithMiddleware` is given\nmultiple times, for example first in the client then the method, the\nmiddleware in the client will run first and the middleware given in the method\nwill run next.\n\nYou may also replace the default `http.Client` with\n`SDK_PackageOptionName.WithHTTPClient(client)`. Only one http client is\naccepted (this overwrites any previous client) and receives requests after any\nmiddleware has been applied.\n\n## Semantic versioning\n\nThis package generally follows [SemVer](https://semver.org/spec/v2.0.0.html) conventions, though certain backwards-incompatible changes may be released as minor versions:\n\n1. Changes to library internals which are technically public but not intended or documented for external use. _(Please open a GitHub issue to let us know if you are relying on such internals.)_\n2. Changes that we do not expect to impact the vast majority of users in practice.\n\nWe take backwards-compatibility seriously and work hard to ensure you can rely on a smooth upgrade experience.\n\nWe are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/piercenew-go/issues) with questions, bugs, or suggestions.\n\n## Contributing\n\nSee [the contributing documentation](./CONTRIBUTING.md).\n',
  },
  {
    language: 'java',
    content:
      '# Piercenew Java API Library\n\n\n[![Maven Central](https://img.shields.io/maven-central/v/com.piercenew.api/piercenew-java)](https://central.sonatype.com/artifact/com.piercenew.api/piercenew-java/0.0.1)\n[![javadoc](https://javadoc.io/badge2/com.piercenew.api/piercenew-java/0.0.1/javadoc.svg)](https://javadoc.io/doc/com.piercenew.api/piercenew-java/0.0.1)\n\n\nThe Piercenew Java SDK provides convenient access to the Piercenew REST API   from applications written in Java.\n\n\n\nIt is generated with [Stainless](https://www.stainless.com/).\n\n## MCP Server\n\nUse the Piercenew MCP Server to enable AI assistants to interact with this API, allowing them to explore endpoints, make test requests, and use documentation to help integrate this SDK into your application.\n\n[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=piercenew-mcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyIteSIsInBpZXJjZW5ldy1tY3AiXSwiZW52Ijp7IlBFVFNUT1JFX0FQSV9LRVkiOiJNeSBBUEkgS2V5In19)\n[![Install in VS Code](https://img.shields.io/badge/_-Add_to_VS_Code-blue?style=for-the-badge&logo=data:image/svg%2bxml;base64,)](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22piercenew-mcp%22%2C%22command%22%3A%22npx%22%2C%22args%22%3A%5B%22-y%22%2C%22piercenew-mcp%22%5D%2C%22env%22%3A%7B%22PETSTORE_API_KEY%22%3A%22My%20API%20Key%22%7D%7D)\n\n> Note: You may need to set environment variables in your MCP client.\n\nJavadocs are available on [javadoc.io](https://javadoc.io/doc/com.piercenew.api/piercenew-java/0.0.1).\n\n## Installation\n\n### Gradle\n\n~~~kotlin\nimplementation("com.piercenew.api:piercenew-java:0.0.1")\n~~~\n\n### Maven\n\n~~~xml\n<dependency>\n  <groupId>com.piercenew.api</groupId>\n  <artifactId>piercenew-java</artifactId>\n  <version>0.0.1</version>\n</dependency>\n~~~\n\n## Requirements\n\nThis library requires Java 8 or later.\n\n## Usage\n\n```java\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.models.Order;\nimport com.piercenew.api.models.store.orders.OrderCreateParams;\n\n// Configures using the `piercenew.petstoreApiKey` and `piercenew.baseUrl` system properties\n// Or configures using the `PETSTORE_API_KEY` and `PIERCENEW_BASE_URL` environment variables\nPiercenewClient client = PiercenewOkHttpClient.fromEnv();\n\nOrder order = client.store().orders().create();\n```\n\n## Client configuration\n\nConfigure the client using system properties or environment variables:\n\n```java\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\n\n// Configures using the `piercenew.petstoreApiKey` and `piercenew.baseUrl` system properties\n// Or configures using the `PETSTORE_API_KEY` and `PIERCENEW_BASE_URL` environment variables\nPiercenewClient client = PiercenewOkHttpClient.fromEnv();\n```\n\nOr manually:\n\n```java\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\n\nPiercenewClient client = PiercenewOkHttpClient.builder()\n    .apiKey("My API Key")\n    .build();\n```\n\nOr using a combination of the two approaches:\n\n```java\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\n\nPiercenewClient client = PiercenewOkHttpClient.builder()\n    // Configures using the `piercenew.petstoreApiKey` and `piercenew.baseUrl` system properties\n    // Or configures using the `PETSTORE_API_KEY` and `PIERCENEW_BASE_URL` environment variables\n    .fromEnv()\n    .apiKey("My API Key")\n    .build();\n```\n\nSee this table for the available options:\n\n| Setter    | System property            | Environment variable | Required | Default value                           |\n| --------- | -------------------------- | -------------------- | -------- | --------------------------------------- |\n| `apiKey`  | `piercenew.petstoreApiKey` | `PETSTORE_API_KEY`   | true     | -                                       |\n| `baseUrl` | `piercenew.baseUrl`        | `PIERCENEW_BASE_URL` | true     | `"https://petstore3.swagger.io/api/v3"` |\n\nSystem properties take precedence over environment variables.\n\n> [!TIP]\n> Don\'t create more than one client in the same application. Each client has a connection pool and\n> thread pools, which are more efficient to share between requests.\n\n### Modifying configuration\n\nTo temporarily use a modified client configuration, while reusing the same connection and thread       pools, call `withOptions()` on any client or service:\n\n```java\nimport com.piercenew.api.client.PiercenewClient;\n\nPiercenewClient clientWithOptions = client.withOptions(optionsBuilder -> {\n    optionsBuilder.baseUrl("https://example.com");\n    optionsBuilder.maxRetries(42);\n});\n```\n\nThe `withOptions()` method does not affect the original client or service.\n\n## Requests and responses\n\nTo send a request to the Piercenew API, build an instance of some `Params` class and pass it to the     corresponding client method. When the response is received, it will be deserialized into an instance of     a Java class.\n\nFor example, `client.store().orders().create(...)` should be called with an instance of `OrderCreateParams`, and it     will return an instance of `Order`.\n\n## Immutability\n\nEach class in the SDK has an associated   [builder](https://blogs.oracle.com/javamagazine/post/exploring-joshua-blochs-builder-design-pattern-in-java)   or factory method for constructing it.\n\nEach class is [immutable](https://docs.oracle.com/javase/tutorial/essential/concurrency/immutable.html)   once constructed. If the class has an associated builder, then it has a `toBuilder()` method, which can   be used to convert it back to a builder for making a modified copy.\n\nBecause each class is immutable, builder modification will _never_ affect already built class instances.\n\n## Asynchronous execution\n\nThe default client is synchronous. To switch to asynchronous execution, call the `async()` method:\n\n```java\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.models.Order;\nimport com.piercenew.api.models.store.orders.OrderCreateParams;\nimport java.util.concurrent.CompletableFuture;\n\n// Configures using the `piercenew.petstoreApiKey` and `piercenew.baseUrl` system properties\n// Or configures using the `PETSTORE_API_KEY` and `PIERCENEW_BASE_URL` environment variables\nPiercenewClient client = PiercenewOkHttpClient.fromEnv();\n\nCompletableFuture<Order> order = client.async().store().orders().create();\n```\n\nOr create an asynchronous client from the beginning:\n\n```java\nimport com.piercenew.api.client.PiercenewClientAsync;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClientAsync;\nimport com.piercenew.api.models.Order;\nimport com.piercenew.api.models.store.orders.OrderCreateParams;\nimport java.util.concurrent.CompletableFuture;\n\n// Configures using the `piercenew.petstoreApiKey` and `piercenew.baseUrl` system properties\n// Or configures using the `PETSTORE_API_KEY` and `PIERCENEW_BASE_URL` environment variables\nPiercenewClientAsync client = PiercenewOkHttpClientAsync.fromEnv();\n\nCompletableFuture<Order> order = client.store().orders().create();\n```\n\nThe asynchronous client supports the same options as the synchronous one, except most methods return `CompletableFuture`s.\n\n\n\n\n\n\n\n## Raw responses\n\nThe SDK defines methods that deserialize responses into instances of Java classes.       However, these methods don\'t provide access to the response headers, status code, or the raw response       body.\n\nTo access this data, prefix any HTTP method call on a client or service with `withRawResponse()`:\n\n```java\nimport com.piercenew.api.core.http.Headers;\nimport com.piercenew.api.core.http.HttpResponseFor;\nimport com.piercenew.api.models.store.StoreListInventoryParams;\nimport com.piercenew.api.models.store.StoreListInventoryResponse;\n\nHttpResponseFor<StoreListInventoryResponse> response = client.store().withRawResponse().listInventory();\n\nint statusCode = response.statusCode();\nHeaders headers = response.headers();\n```\n\nYou can still deserialize the response into an instance of a Java class if needed:\n\n```java\nimport com.piercenew.api.models.store.StoreListInventoryResponse;\n\nStoreListInventoryResponse parsedResponse = response.parse();\n```\n\n## Error handling\n\nThe SDK throws custom unchecked exception types:\n\n- [`PiercenewServiceException`](piercenew-java-core/src/main/kotlin/com/piercenew/api/errors/PiercenewServiceException.kt): Base class for HTTP errors. See this table for which exception       subclass is thrown for each HTTP status code:\n\n  | Status | Exception                                          |\n  | ------ | -------------------------------------------------- |\n  | 400    | [`BadRequestException`](piercenew-java-core/src/main/kotlin/com/piercenew/api/errors/BadRequestException.kt)           |\n  | 401    | [`UnauthorizedException`](piercenew-java-core/src/main/kotlin/com/piercenew/api/errors/UnauthorizedException.kt)         |\n  | 403    | [`PermissionDeniedException`](piercenew-java-core/src/main/kotlin/com/piercenew/api/errors/PermissionDeniedException.kt)     |\n  | 404    | [`NotFoundException`](piercenew-java-core/src/main/kotlin/com/piercenew/api/errors/NotFoundException.kt)             |\n  | 422    | [`UnprocessableEntityException`](piercenew-java-core/src/main/kotlin/com/piercenew/api/errors/UnprocessableEntityException.kt)  |\n  | 429    | [`RateLimitException`](piercenew-java-core/src/main/kotlin/com/piercenew/api/errors/RateLimitException.kt)            |\n  | 5xx    | [`InternalServerException`](piercenew-java-core/src/main/kotlin/com/piercenew/api/errors/InternalServerException.kt)       |\n  | others | [`UnexpectedStatusCodeException`](piercenew-java-core/src/main/kotlin/com/piercenew/api/errors/UnexpectedStatusCodeException.kt) |\n\n- [`PiercenewIoException`](piercenew-java-core/src/main/kotlin/com/piercenew/api/errors/PiercenewIoException.kt): I/O networking errors.\n\n- [`PiercenewRetryableException`](piercenew-java-core/src/main/kotlin/com/piercenew/api/errors/PiercenewRetryableException.kt): Generic error indicating a failure that could be retried by the client.\n\n- [`PiercenewInvalidDataException`](piercenew-java-core/src/main/kotlin/com/piercenew/api/errors/PiercenewInvalidDataException.kt): Failure to interpret successfully parsed data. For example,       when accessing a property that\'s supposed to be required, but the API unexpectedly omitted it from the       response.\n\n- [`PiercenewException`](piercenew-java-core/src/main/kotlin/com/piercenew/api/errors/PiercenewException.kt): Base class for all exceptions. Most errors will result in one of the       previously mentioned ones, but completely generic errors may be thrown using the base class.\n\n\n\n## Logging\n\nEnable logging by setting the `PIERCENEW_LOG` environment variable to   `info`:\n\n```sh\nexport PIERCENEW_LOG=info\n```\n\nOr to `debug` for more verbose logging:\n\n```sh\nexport PIERCENEW_LOG=debug\n```\n\nOr configure the client manually using the `logLevel` method:\n\n```java\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.core.LogLevel;\n\nPiercenewClient client = PiercenewOkHttpClient.builder()\n    .fromEnv()\n    .logLevel(LogLevel.INFO)\n    .build();\n```\n\n## ProGuard and R8\n\nAlthough the SDK uses reflection, it is still usable with     [ProGuard](https://github.com/Guardsquare/proguard) and     [R8](https://developer.android.com/topic/performance/app-optimization/enable-app-optimization) because     `piercenew-java-core` is published with a     [configuration file](piercenew-java-core/src/main/resources/META-INF/proguard/piercenew-java-core.pro) containing     [keep rules](https://www.guardsquare.com/manual/configuration/usage).\n\nProGuard and R8 should automatically detect and use the published rules, but you can also manually copy     the keep rules if necessary.\n\n\n\n\n\n## Jackson\n\nThe SDK depends on [Jackson](https://github.com/FasterXML/jackson) for JSON     serialization/deserialization. It is compatible with version 2.13.4 or higher,     but depends on version 2.18.2 by default.\n\nThe SDK throws an exception if it detects an incompatible Jackson version at runtime (e.g. if the     default version was overridden in your Maven or Gradle config).\n\nIf the SDK threw an exception, but you\'re _certain_ the version is compatible, then disable the version     check using the `checkJacksonVersionCompatibility` on [`PiercenewOkHttpClient`](piercenew-java-client-okhttp/src/main/kotlin/com/piercenew/api/client/okhttp/PiercenewOkHttpClient.kt) or     [`PiercenewOkHttpClientAsync`](piercenew-java-client-okhttp/src/main/kotlin/com/piercenew/api/client/okhttp/PiercenewOkHttpClientAsync.kt).\n\n> [!CAUTION]\n> We make no guarantee that the SDK works correctly when the Jackson version check is disabled.\n\nAlso note that there are bugs in older Jackson versions that can affect the SDK. We don\'t work around all     Jackson bugs ([example](https://github.com/FasterXML/jackson-databind/issues/3240)) and expect users to     upgrade Jackson for those instead.\n\n## Network options\n\n### Retries\n\nThe SDK automatically retries 2 times by default, with a short exponential backoff between requests.\n\nOnly the following error types are retried:\n- Connection errors (for example, due to a network connectivity problem)\n- 408 Request Timeout\n- 409 Conflict\n- 429 Rate Limit\n- 5xx Internal\n\nThe API may also explicitly instruct the SDK to retry or not retry a request.\n\nTo set a custom number of retries, configure the client using the `maxRetries` method:\n\n```java\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\n\nPiercenewClient client = PiercenewOkHttpClient.builder()\n    .fromEnv()\n    .maxRetries(4)\n    .build();\n```\n\n### Timeouts\n\nRequests time out after 1 minute by default.\n\nTo set a custom timeout, configure the method call using the `timeout` method:\n\n```java\nimport com.piercenew.api.models.store.StoreListInventoryResponse;\n\nStoreListInventoryResponse response = client.store().listInventory(RequestOptions.builder().timeout(Duration.ofSeconds(30)).build());\n```\n\nOr configure the default for all method calls at the client level:\n\n```java\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport java.time.Duration;\n\nPiercenewClient client = PiercenewOkHttpClient.builder()\n    .fromEnv()\n    .timeout(Duration.ofSeconds(30))\n    .build();\n```\n\n### Proxies\n\nTo route requests through a proxy, configure the client using the `proxy` method:\n\n```java\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport java.net.InetSocketAddress;\nimport java.net.Proxy;\n\nPiercenewClient client = PiercenewOkHttpClient.builder()\n    .fromEnv()\n    .proxy(new Proxy(\n      Proxy.Type.HTTP, new InetSocketAddress(\n        "https://example.com", 8080\n      )\n    ))\n    .build();\n```\n\nIf the proxy responds with `407 Proxy Authentication Required`, supply credentials by also   configuring `proxyAuthenticator`:\n\n```java\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport com.piercenew.api.core.http.ProxyAuthenticator;\n\nPiercenewClient client = PiercenewOkHttpClient.builder()\n    .fromEnv()\n    .proxy(...)\n    // Or a custom implementation of `ProxyAuthenticator`.\n    .proxyAuthenticator(ProxyAuthenticator.basic("username", "password"))\n    .build();\n```\n\n### Connection pooling\n\nTo customize the underlying OkHttp connection pool, configure the client using the   `maxIdleConnections` and `keepAliveDuration` methods:\n\n```java\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\nimport java.time.Duration;\n\nPiercenewClient client = PiercenewOkHttpClient.builder()\n    .fromEnv()\n    // If `maxIdleConnections` is set, then `keepAliveDuration` must be set, and vice versa.\n    .maxIdleConnections(10)\n    .keepAliveDuration(Duration.ofMinutes(2))\n    .build();\n```\n\nIf both options are unset, OkHttp\'s default connection pool settings are used.\n\n### HTTPS\n\n> [!NOTE]\n> Most applications should not call these methods, and instead use the system defaults. The defaults include\n> special optimizations that can be lost if the implementations are modified.\n\nTo configure how HTTPS connections are secured, configure the client using the `sslSocketFactory`,   `trustManager`, and `hostnameVerifier` methods:\n\n```java\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\n\nPiercenewClient client = PiercenewOkHttpClient.builder()\n    .fromEnv()\n    // If `sslSocketFactory` is set, then `trustManager` must be set, and vice versa.\n    .sslSocketFactory(yourSSLSocketFactory)\n    .trustManager(yourTrustManager)\n    .hostnameVerifier(yourHostnameVerifier)\n    .build();\n```\n\n\n\n### Custom HTTP client\n\nThe SDK consists of three artifacts:\n- `piercenew-java-core`\n  - Contains core SDK logic\n  - Does not depend on [OkHttp](https://square.github.io/okhttp)\n  - Exposes [`PiercenewClient`](piercenew-java-core/src/main/kotlin/com/piercenew/api/client/PiercenewClient.kt), [`PiercenewClientAsync`](piercenew-java-core/src/main/kotlin/com/piercenew/api/client/PiercenewClientAsync.kt),             [`PiercenewClientImpl`](piercenew-java-core/src/main/kotlin/com/piercenew/api/client/PiercenewClientImpl.kt), and [`PiercenewClientAsyncImpl`](piercenew-java-core/src/main/kotlin/com/piercenew/api/client/PiercenewClientAsyncImpl.kt), all of which can             work with any HTTP client\n- `piercenew-java-client-okhttp`\n  - Depends on [OkHttp](https://square.github.io/okhttp)\n  - Exposes [`PiercenewOkHttpClient`](piercenew-java-client-okhttp/src/main/kotlin/com/piercenew/api/client/okhttp/PiercenewOkHttpClient.kt) and [`PiercenewOkHttpClientAsync`](piercenew-java-client-okhttp/src/main/kotlin/com/piercenew/api/client/okhttp/PiercenewOkHttpClientAsync.kt), which             provide a way to construct [`PiercenewClientImpl`](piercenew-java-core/src/main/kotlin/com/piercenew/api/client/PiercenewClientImpl.kt) and             [`PiercenewClientAsyncImpl`](piercenew-java-core/src/main/kotlin/com/piercenew/api/client/PiercenewClientAsyncImpl.kt), respectively, using OkHttp\n- `piercenew-java`\n  - Depends on and exposes the APIs of both `piercenew-java-core` and `piercenew-java-client-okhttp`\n  - Does not have its own logic\n\nThis structure allows replacing the SDK\'s default HTTP client without pulling in unnecessary dependencies.\n\n#### Customized [`OkHttpClient`](https://square.github.io/okhttp/3.x/okhttp/okhttp3/OkHttpClient.html)\n\n> [!TIP]\n> Try the available [network options](#network-options) before replacing the default client.\n\nTo use a customized `OkHttpClient`:\n\n1. Replace your [`piercenew-java` dependency](#installation) with `piercenew-java-core`\n2. Copy `piercenew-java-client-okhttp`\'s [`OkHttpClient`](piercenew-java-client-okhttp/src/main/kotlin/com/piercenew/api/client/okhttp/OkHttpClient.kt) class into your code and        customize it\n3. Construct [`PiercenewClientImpl`](piercenew-java-core/src/main/kotlin/com/piercenew/api/client/PiercenewClientImpl.kt) or [`PiercenewClientAsyncImpl`](piercenew-java-core/src/main/kotlin/com/piercenew/api/client/PiercenewClientAsyncImpl.kt), similarly to        [`PiercenewOkHttpClient`](piercenew-java-client-okhttp/src/main/kotlin/com/piercenew/api/client/okhttp/PiercenewOkHttpClient.kt) or [`PiercenewOkHttpClientAsync`](piercenew-java-client-okhttp/src/main/kotlin/com/piercenew/api/client/okhttp/PiercenewOkHttpClientAsync.kt), using your        customized client\n\n### Completely custom HTTP client\n\nTo use a completely custom HTTP client:\n\n1. Replace your [`piercenew-java` dependency](#installation) with `piercenew-java-core`\n2. Write a class that implements the [`HttpClient`](piercenew-java-core/src/main/kotlin/com/piercenew/api/core/http/HttpClient.kt) interface\n3. Construct [`PiercenewClientImpl`](piercenew-java-core/src/main/kotlin/com/piercenew/api/client/PiercenewClientImpl.kt) or [`PiercenewClientAsyncImpl`](piercenew-java-core/src/main/kotlin/com/piercenew/api/client/PiercenewClientAsyncImpl.kt), similarly to        [`PiercenewOkHttpClient`](piercenew-java-client-okhttp/src/main/kotlin/com/piercenew/api/client/okhttp/PiercenewOkHttpClient.kt) or [`PiercenewOkHttpClientAsync`](piercenew-java-client-okhttp/src/main/kotlin/com/piercenew/api/client/okhttp/PiercenewOkHttpClientAsync.kt), using your new        client class\n\n## Undocumented API functionality\n\nThe SDK is typed for convenient usage of the documented API. However, it also supports working with undocumented or not yet supported parts of the API.\n\n### Parameters\n\nTo set undocumented parameters, call the `putAdditionalHeader`, `putAdditionalQueryParam`, or       `putAdditionalBodyProperty` methods on any `Params` class:\n\n```java\nimport com.piercenew.api.core.JsonValue;\nimport com.piercenew.api.models.store.orders.OrderCreateParams;\n\nOrderCreateParams params = OrderCreateParams.builder()\n    .putAdditionalHeader("Secret-Header", "42")\n    .putAdditionalQueryParam("secret_query_param", "42")\n    .putAdditionalBodyProperty("secretProperty", JsonValue.from("42"))\n    .build();\n```\n\nThese can be accessed on the built object later using the `_additionalHeaders()`,       `_additionalQueryParams()`, and `_additionalBodyProperties()` methods.\n\nTo set a documented parameter or property to an undocumented or not yet supported _value_, pass a       [`JsonValue`](piercenew-java-core/src/main/kotlin/com/piercenew/api/core/Values.kt) object to its setter:\n\n```java\nimport com.piercenew.api.models.store.orders.OrderCreateParams;\n\nOrderCreateParams params = OrderCreateParams.builder().build();\n```\n\nThe most straightforward way to create a [`JsonValue`](piercenew-java-core/src/main/kotlin/com/piercenew/api/core/Values.kt) is using its       `from(...)` method:\n\n```java\nimport com.piercenew.api.core.JsonValue;\nimport java.util.List;\nimport java.util.Map;\n\n// Create primitive JSON values\nJsonValue nullValue = JsonValue.from(null);\nJsonValue booleanValue = JsonValue.from(true);\nJsonValue numberValue = JsonValue.from(42);\nJsonValue stringValue = JsonValue.from("Hello World!");\n\n// Create a JSON array value equivalent to `["Hello", "World"]`\nJsonValue arrayValue = JsonValue.from(List.of(\n  "Hello", "World"\n));\n\n// Create a JSON object value equivalent to `{ "a": 1, "b": 2 }`\nJsonValue objectValue = JsonValue.from(Map.of(\n  "a", 1,\n  "b", 2\n));\n\n// Create an arbitrarily nested JSON equivalent to:\n// {\n//   "a": [1, 2],\n//   "b": [3, 4]\n// }\nJsonValue complexValue = JsonValue.from(Map.of(\n  "a", List.of(\n    1, 2\n  ),\n  "b", List.of(\n    3, 4\n  )\n));\n```\n\nNormally a `Builder` class\'s `build` method will throw         [`IllegalStateException`](https://docs.oracle.com/javase/8/docs/api/java/lang/IllegalStateException.html)         if any required parameter or property is unset.\n\nTo forcibly omit a required parameter or property, pass [`JsonMissing`](piercenew-java-core/src/main/kotlin/com/piercenew/api/core/Values.kt):\n\n```java\nimport com.piercenew.api.core.JsonMissing;\nimport com.piercenew.api.models.pets.Pet;\nimport com.piercenew.api.models.pets.PetCreateParams;\nimport com.piercenew.api.models.store.orders.OrderCreateParams;\n\nOrderCreateParams params = PetCreateParams.builder()\n    .pet(Pet.builder()\n        .name("doggie")\n        .addPhotoUrl("string")\n        .build())\n    .name(JsonMissing.of())\n    .build();\n```\n\n### Response properties\n\nTo access undocumented response properties, call the `_additionalProperties()` method:\n\n```java\nimport com.piercenew.api.core.JsonValue;\nimport java.util.Map;\n\nMap<String, JsonValue> additionalProperties = client.store().orders().create(params)._additionalProperties();\nJsonValue secretPropertyValue = additionalProperties.get("secretProperty");\n\nString result = secretPropertyValue.accept(new JsonValue.Visitor<>() {\n    @Override\n    public String visitNull() {\n        return "It\'s null!";\n    }\n\n    @Override\n    public String visitBoolean(boolean value) {\n        return "It\'s a boolean!";\n    }\n\n    @Override\n    public String visitNumber(Number value) {\n        return "It\'s a number!";\n    }\n\n    // Other methods include `visitMissing`, `visitString`, `visitArray`, and `visitObject`\n    // The default implementation of each unimplemented method delegates to `visitDefault`, which throws by default, but can also be overridden\n});\n```\n\nTo access a property\'s raw JSON value, which may be undocumented, call its `_` prefixed method:\n\n```java\nimport com.piercenew.api.core.JsonField;\nimport java.util.Optional;\n\nJsonField<Object> field = client.store().orders().create(params)._field();\n\nif (field.isMissing()) {\n  // The property is absent from the JSON response\n} else if (field.isNull()) {\n  // The property was set to literal null\n} else {\n  // Check if value was provided as a string\n  // Other methods include `asNumber()`, `asBoolean()`, etc.\n  Optional<String> jsonString = field.asString();\n\n  // Try to deserialize into a custom type\n  MyClass myObject = field.asUnknown().orElseThrow().convert(MyClass.class);\n}\n```\n\n### Response validation\n\nIn rare cases, the API may return a response that doesn\'t match the expected type. For example, the SDK     may expect a property to contain a `String`, but the API could return something else.\n\nBy default, the SDK will not throw an exception in this case. It will throw     [`PiercenewInvalidDataException`](piercenew-java-core/src/main/kotlin/com/piercenew/api/errors/PiercenewInvalidDataException.kt) only if you directly access the property.\n\nValidating the response is _not_ forwards compatible with new types from the API for existing fields.\n\nIf you would still prefer to check that the response is completely well-typed upfront, then either call     `validate()`:\n\n```java\nimport com.piercenew.api.models.Order;\n\nOrder order = client.store().orders().create(params).validate();\n```\n\nOr configure the method call to validate the response using the `responseValidation` method:\n\n```java\nimport com.piercenew.api.models.Order;\n\nOrder order = client.store().orders().create(RequestOptions.builder().responseValidation(true).build());\n```\n\nOr configure the default for all method calls at the client level:\n\n```java\nimport com.piercenew.api.client.PiercenewClient;\nimport com.piercenew.api.client.okhttp.PiercenewOkHttpClient;\n\nPiercenewClient client = PiercenewOkHttpClient.builder()\n    .fromEnv()\n    .responseValidation(true)\n    .build();\n```\n\n## FAQ\n\n### Why don\'t you use plain `enum` classes?\n\nJava `enum` classes are not trivially   [forwards compatible](https://www.stainless.com/blog/making-java-enums-forwards-compatible). Using them in   the SDK could cause runtime exceptions if the API is updated to respond with a new enum value.\n\n### Why do you represent fields using `JsonField<T>` instead of just plain `T`?\n\nUsing `JsonField<T>` enables a few features:\n\n- Allowing usage of [undocumented API functionality](#undocumented-api-functionality)\n- Lazily [validating the API response against the expected shape](#response-validation)\n- Representing absent vs explicitly null values\n\n### Why don\'t you use [`data` classes](https://kotlinlang.org/docs/data-classes.html)?\n\nIt is not [backwards compatible to add new fields to a data class](https://kotlinlang.org/docs/api-guidelines-backward-compatibility.html#avoid-using-data-classes-in-your-api)   and we don\'t want to introduce a breaking change every time we add a field to a class.\n\n### Why don\'t you use checked exceptions?\n\nChecked exceptions are widely considered a mistake in the Java programming language. In fact, they were   omitted from Kotlin for this reason.\n\nChecked exceptions:\n\n- Are verbose to handle\n- Encourage error handling at the wrong level of abstraction, where nothing can be done about the error\n- Are tedious to propagate due to the [function coloring problem](https://journal.stuffwithstuff.com/2015/02/01/what-color-is-your-function)\n- Don\'t play well with lambdas (also due to the function coloring problem)\n\n## Semantic versioning\n\nThis package generally follows [SemVer](https://semver.org/spec/v2.0.0.html) conventions, though certain backwards-incompatible changes may be released as minor versions:\n\n1. Changes to library internals which are technically public but not intended or documented for external use. _(Please open a GitHub issue to let us know if you are relying on such internals.)_\n2. Changes that we do not expect to impact the vast majority of users in practice.\n\nWe take backwards-compatibility seriously and work hard to ensure you can rely on a smooth upgrade experience.\n\nWe are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/piercenew-java/issues) with questions, bugs, or suggestions.\n',
  },
  {
    language: 'python',
    content:
      '# Piercenew Python API library\n\n<!-- prettier-ignore -->\n[![PyPI version](https://img.shields.io/pypi/v/piercenew.svg?label=pypi%20(stable))](https://pypi.org/project/piercenew/)\n\nThe Piercenew Python library provides convenient access to the Piercenew REST API from any Python 3.9+\napplication. The library includes type definitions for all request params and response fields,\nand offers both synchronous and asynchronous clients powered by [httpx](https://github.com/encode/httpx).\n\n\n\nIt is generated with [Stainless](https://www.stainless.com/).\n\n## MCP Server\n\nUse the Piercenew MCP Server to enable AI assistants to interact with this API, allowing them to explore endpoints, make test requests, and use documentation to help integrate this SDK into your application.\n\n[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=piercenew-mcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyIteSIsInBpZXJjZW5ldy1tY3AiXSwiZW52Ijp7IlBFVFNUT1JFX0FQSV9LRVkiOiJNeSBBUEkgS2V5In19)\n[![Install in VS Code](https://img.shields.io/badge/_-Add_to_VS_Code-blue?style=for-the-badge&logo=data:image/svg%2bxml;base64,)](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22piercenew-mcp%22%2C%22command%22%3A%22npx%22%2C%22args%22%3A%5B%22-y%22%2C%22piercenew-mcp%22%5D%2C%22env%22%3A%7B%22PETSTORE_API_KEY%22%3A%22My%20API%20Key%22%7D%7D)\n\n> Note: You may need to set environment variables in your MCP client.\n\n## Documentation\n\n The full API of this library can be found in [api.md](api.md).\n\n## Installation\n\n```sh\n# install from this staging repo\npip install git+ssh://git@github.com/stainless-sdks/piercenew-python.git\n```\n> [!NOTE]\n> Once this package is [published to PyPI](https://www.stainless.com/docs/guides/publish), this will become: `pip install piercenew`\n\n## Usage\n\nThe full API of this library can be found in [api.md](api.md).\n\n```python\nimport os\nfrom piercenew import Piercenew\n\nclient = Piercenew(\n    api_key=os.environ.get("PETSTORE_API_KEY"),  # This is the default and can be omitted\n)\n\norder = client.store.orders.create(\n    pet_id=1,\n    quantity=1,\n    status="placed",\n)\nprint(order.id)\n```\n\nWhile you can provide an `api_key` keyword argument,\nwe recommend using [python-dotenv](https://pypi.org/project/python-dotenv/)\nto add `PETSTORE_API_KEY="My API Key"` to your `.env` file\nso that your API Key is not stored in source control.\n\n## Async usage\n\nSimply import `AsyncPiercenew` instead of `Piercenew` and use `await` with each API call:\n\n```python\nimport os\nimport asyncio\nfrom piercenew import AsyncPiercenew\n\nclient = AsyncPiercenew(\n    api_key=os.environ.get("PETSTORE_API_KEY"),  # This is the default and can be omitted\n)\n\nasync def main() -> None:\n  order = await client.store.orders.create(\n      pet_id=1,\n      quantity=1,\n      status="placed",\n  )\n  print(order.id)\n\nasyncio.run(main())\n```\n\nFunctionality between the synchronous and asynchronous clients is otherwise identical.\n\n### With aiohttp\n\nBy default, the async client uses `httpx` for HTTP requests. However, for improved concurrency performance you may also use `aiohttp` as the HTTP backend.\n\nYou can enable this by installing `aiohttp`:\n\n```sh\n# install from this staging repo\npip install \'piercenew[aiohttp] @ git+ssh://git@github.com/stainless-sdks/piercenew-python.git\'\n```\n\nThen you can enable it by instantiating the client with `http_client=DefaultAioHttpClient()`:\n\n```python\nimport os\nimport asyncio\nfrom piercenew import DefaultAioHttpClient\nfrom piercenew import AsyncPiercenew\n\nasync def main() -> None:\n  async with AsyncPiercenew(\n    api_key=os.environ.get("PETSTORE_API_KEY"),  # This is the default and can be omitted\n    http_client=DefaultAioHttpClient(),\n) as client:\n    order = await client.store.orders.create(\n        pet_id=1,\n        quantity=1,\n        status="placed",\n    )\n    print(order.id)\n\nasyncio.run(main())\n```\n\n\n\n## Using types\n\nNested request parameters are [TypedDicts](https://docs.python.org/3/library/typing.html#typing.TypedDict). Responses are [Pydantic models](https://docs.pydantic.dev) which also provide helper methods for things like:\n\n- Serializing back into JSON, `model.to_json()`\n- Converting to a dictionary, `model.to_dict()`\n\nTyped requests and responses provide autocomplete and documentation within your editor. If you would like to see type errors in VS Code to help catch bugs earlier, set `python.analysis.typeCheckingMode` to `basic`.\n\n\n\n## Nested params\n\nNested parameters are dictionaries, typed using `TypedDict`, for example:\n\n```python\nfrom piercenew import Piercenew\n\nclient = Piercenew()\n\npet = client.pets.create(\n    name="doggie",\n    photo_urls=["string"],\n    category={},\n)\nprint(pet.category)\n```\n\n\n\n## Handling errors\n\nWhen the library is unable to connect to the API (for example, due to network connection problems or a timeout), a subclass of `piercenew.APIConnectionError` is raised.\n\nWhen the API returns a non-success status code (that is, 4xx or 5xx\nresponse), a subclass of `piercenew.APIStatusError` is raised, containing `status_code` and `response` properties.\n\nAll errors inherit from `piercenew.APIError`.\n\n```python\nimport piercenew\nfrom piercenew import Piercenew\n\nclient = Piercenew()\n\ntry:\n    client.store.list_inventory()\nexcept piercenew.APIConnectionError as e:\n    print("The server could not be reached")\n    print(e.__cause__) # an underlying Exception, likely raised within httpx.\nexcept piercenew.RateLimitError as e:\n    print("A 429 status code was received; we should back off a bit.")\nexcept piercenew.APIStatusError as e:\n    print("Another non-200-range status code was received")\n    print(e.status_code)\n    print(e.response)\n```\n\nError codes are as follows:\n\n| Status Code | Error Type                 |\n| ----------- | -------------------------- |\n| 400         | `BadRequestError`          |\n| 401         | `AuthenticationError`      |\n| 403         | `PermissionDeniedError`    |\n| 404         | `NotFoundError`            |\n| 422         | `UnprocessableEntityError` |\n| 429         | `RateLimitError`           |\n| >=500       | `InternalServerError`      |\n| N/A         | `APIConnectionError`       |\n\n### Retries\n\nCertain errors are automatically retried 2 times by default, with a short exponential backoff.\nConnection errors (for example, due to a network connectivity problem), 408 Request Timeout, 409 Conflict,\n429 Rate Limit, and >=500 Internal errors are all retried by default.\n\nYou can use the `max_retries` option to configure or disable retry settings:\n\n```python\nfrom piercenew import Piercenew\n\n# Configure the default for all requests:\nclient = Piercenew(\n    # default is 2\n    max_retries=0,\n)\n\n# Or, configure per-request:\nclient.with_options(max_retries = 5).store.list_inventory()\n```\n\n### Timeouts\n\nBy default requests time out after 1 minute. You can configure this with a `timeout` option,\nwhich accepts a float or an [`httpx.Timeout`](https://www.python-httpx.org/advanced/timeouts/#fine-tuning-the-configuration) object:\n\n```python\nfrom piercenew import Piercenew\n\n# Configure the default for all requests:\nclient = Piercenew(\n    # 20 seconds (default is 1 minute)\n    timeout=20.0,\n)\n\n# More granular control:\nclient = Piercenew(\n    timeout=httpx.Timeout(60.0, read=5.0, write=10.0, connect=2.0),\n)\n\n# Override per-request:\nclient.with_options(timeout = 5.0).store.list_inventory()\n```\n\nOn timeout, an `APITimeoutError` is thrown.\n\nNote that requests that time out are [retried twice by default](#retries).\n\n\n\n## Advanced\n\n### Logging\n\nWe use the standard library [`logging`](https://docs.python.org/3/library/logging.html) module.\n\nYou can enable logging by setting the environment variable `PIERCENEW_LOG` to `info`.\n\n```shell\n$ export PIERCENEW_LOG=info\n```\n\nOr to `debug` for more verbose logging.\n\n### How to tell whether `None` means `null` or missing\n\nIn an API response, a field may be explicitly `null`, or missing entirely; in either case, its value is `None` in this library. You can differentiate the two cases with `.model_fields_set`:\n\n```py\nif response.my_field is None:\n  if \'my_field\' not in response.model_fields_set:\n    print(\'Got json like {}, without a "my_field" key present at all.\')\n  else:\n    print(\'Got json like {"my_field": null}.\')\n```\n\n### Accessing raw response data (e.g. headers)\n\nThe "raw" Response object can be accessed by prefixing `.with_raw_response.` to any HTTP method call, e.g.,\n\n```py\nfrom piercenew import Piercenew\n\nclient = Piercenew()\nresponse = client.store.with_raw_response.list_inventory()\nprint(response.headers.get(\'X-My-Header\'))\n\nstore = response.parse()  # get the object that `store.list_inventory()` would have returned\nprint(store)\n```\n\nThese methods return an [`APIResponse`](https://github.com/stainless-sdks/piercenew-python/tree/main/src/piercenew/_response.py) object.\n\nThe async client returns an [`AsyncAPIResponse`](https://github.com/stainless-sdks/piercenew-python/tree/main/src/piercenew/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.\n\n#### `.with_streaming_response`\n\nThe above interface eagerly reads the full response body when you make the request, which may not always be what you want.\n\nTo stream the response body, use `.with_streaming_response` instead, which requires a context manager and only reads the response body once you call `.read()`, `.text()`, `.json()`, `.iter_bytes()`, `.iter_text()`, `.iter_lines()` or `.parse()`. In the async client, these are async methods.\n\n```python\nwith client.store.with_streaming_response.list_inventory() as response :\n    print(response.headers.get(\'X-My-Header\'))\n\n    for line in response.iter_lines():\n      print(line)\n```\n\nThe context manager is required so that the response will reliably be closed.\n\n### Making custom/undocumented requests\n\nThis library is typed for convenient access to the documented API.\n\nIf you need to access undocumented endpoints, params, or response properties, the library can still be used.\n\n#### Undocumented endpoints\n\nTo make requests to undocumented endpoints, you can make requests using `client.get`, `client.post`, and other\nhttp verbs. Options on the client will be respected (such as retries) when making this request.\n\n```py\nimport httpx\n\nresponse = client.post(\n    "/foo",\n    cast_to=httpx.Response,\n    body={"my_param": True},\n)\n\nprint(response.headers.get("x-foo"))\n```\n\n#### Undocumented request params\n\nIf you want to explicitly send an extra param, you can do so with the `extra_query`, `extra_body`, and `extra_headers` request\noptions.\n\n#### Undocumented response properties\n\nTo access undocumented response properties, you can access the extra fields like `response.unknown_prop`. You\ncan also get all the extra fields on the Pydantic model as a dict with\n[`response.model_extra`](https://docs.pydantic.dev/latest/api/base_model/#pydantic.BaseModel.model_extra).\n\n### Configuring the HTTP client\n\nYou can directly override the [httpx client](https://www.python-httpx.org/api/#client) to customize it for your use case, including:\n\n- Support for [proxies](https://www.python-httpx.org/advanced/proxies/)\n- Custom [transports](https://www.python-httpx.org/advanced/transports/)\n- Additional [advanced](https://www.python-httpx.org/advanced/clients/) functionality\n\n```python\nimport httpx\nfrom piercenew import Piercenew, DefaultHttpxClient\n\nclient = Piercenew(\n    # Or use the `PIERCENEW_BASE_URL` env var\n    base_url="http://my.test.server.example.com:8083",\n    http_client=DefaultHttpxClient(proxy="http://my.test.proxy.example.com", transport=httpx.HTTPTransport(local_address="0.0.0.0")),\n)\n```\n\nYou can also customize the client on a per-request basis by using `with_options()`:\n\n```python\nclient.with_options(http_client=DefaultHttpxClient(...))\n```\n\n### Managing HTTP resources\n\nBy default the library closes underlying HTTP connections whenever the client is [garbage collected](https://docs.python.org/3/reference/datamodel.html#object.__del__). You can manually close the client using the `.close()` method if desired, or with a context manager that closes when exiting.\n\n```py\nfrom piercenew import Piercenew\n\nwith Piercenew() as client:\n  # make requests here\n  ...\n\n# HTTP client is now closed\n```\n\n## Versioning\n\nThis package generally follows [SemVer](https://semver.org/spec/v2.0.0.html) conventions, though certain backwards-incompatible changes may be released as minor versions:\n\n1. Changes that only affect static types, without breaking runtime behavior.\n2. Changes to library internals which are technically public but not intended or documented for external use. _(Please open a GitHub issue to let us know if you are relying on such internals.)_\n3. Changes that we do not expect to impact the vast majority of users in practice.\n\nWe take backwards-compatibility seriously and work hard to ensure you can rely on a smooth upgrade experience.\n\nWe are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/piercenew-python/issues) with questions, bugs, or suggestions.\n\n### Determining the installed version\n\nIf you\'ve upgraded to the latest version but aren\'t seeing any new features you were expecting then your python environment is likely still using an older version.\n\nYou can determine the version that is being used at runtime with:\n\n```py\nimport piercenew\nprint(piercenew.__version__)\n```\n\n## Requirements\n\nPython 3.9 or higher.\n\n## Contributing\n\nSee [the contributing documentation](./CONTRIBUTING.md).\n',
  },
  {
    language: 'typescript',
    content:
